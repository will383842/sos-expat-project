...
var createStripeAccount_1 = require("./createStripeAccount");
Object.defineProperty(exports, "createStripeAccount", { enumerable: true, get: function () { return createStripeAccount_1.createStripeAccount; } });
...
var stripeAutomaticKyc_1 = require("./stripeAutomaticKyc");
Object.defineProperty(exports, "createCustomAccount", { enumerable: true, get: function () { return stripeAutomaticKyc_1.createCustomAccount; } });
Object.defineProperty(exports, "submitKycData", { enumerable: true, get: function () { return stripeAutomaticKyc_1.submitKycData; } });
Object.defineProperty(exports, "addBankAccount", { enumerable: true, get: function () { return stripeAutomaticKyc_1.addBankAccount; } });
Object.defineProperty(exports, "checkKycStatus", { enumerable: true, get: function () { return stripeAutomaticKyc_1.checkKycStatus; } });
var lawyerOnboarding_1 = require("./lawyerOnboarding");
Object.defineProperty(exports, "completeLawyerOnboarding", { enumerable: true, get: function () { return lawyerOnboarding_1.completeLawyerOnboarding; } });
// Scheduled transfer processing
var processScheduledTransfers_1 = require("./processScheduledTransfers");
Object.defineProperty(exports, "processScheduledTransfers", { enumerable: true, get: function () { return processScheduledTransfers_1.processScheduledTransfers; } });
// ====== IMPORTS PRINCIPAUX ======
        ...
        try {
            ...
            try {
                ...
                ultraDebugLogger_1.ultraLogger.warn("FIREBASE_INIT", "Firestore déjà configuré (normal)", {
                    error: settingsError instanceof Error
...
var providerNoAnswerTwiML_1 = require("./Webhooks/providerNoAnswerTwiML");
Object.defineProperty(exports, "providerNoAnswerTwiML", { enumerable: true, get: function () { return providerNoAnswerTwiML_1.providerNoAnswerTwiML; } });
...
// ========================================
let stripe = null;
exports.getStripe = (0, ultraDebugLogger_1.traceFunction)(() => {
    if (!stripe) {
        ...
        try {
            ...
            ultraDebugLogger_1.ultraLogger.error("STRIPE_INIT", "Secret Stripe non configuré", {
                error: secretError instanceof Error
                    ? secretError.message
                    : String(secretError),
            });
            return null;
...
const sendPaymentNotifications = (0, ultraDebugLogger_1.traceFunction)(async (callSessionId, database) => {
    try {
        ...
        const snap = await database
            ...
            .get();
        if (!snap.exists) {
            ultraDebugLogger_1.ultraLogger.warn("PAYMENT_NOTIFICATIONS", "Session introuvable", {
                callSessionId,
            });
            return;
        }
...
wrapHttpFunction("stripeWebhook", async (req, res) => {
    ...
    const stripeInstance = (0, exports.getStripe)();
    if (!stripeInstance) {
    ...
    try {
        ...
        try {
            ...
            console.log("💥 Error type:", constructError &&
            ...
            res
                .status(400)
                .send(`Webhook Error: ${constructError?.message || constructError}`);
            return;
        }
        ...
        try {
            ...
            res.status(200).json({
                received: true,
                eventId: event.id,
                handlerError: eventHandlerError instanceof Error
                    ? eventHandlerError.message
...
const handlePaymentIntentSucceeded = (0, ultraDebugLogger_1.traceFunction)(async (paymentIntent, database) => {
    try {
        ...
        ultraDebugLogger_1.ultraLogger.error("STRIPE_PAYMENT_SUCCEEDED", "Erreur traitement paiement réussi", {
            paymentIntentId: paymentIntent.id,
            error: succeededError instanceof Error
...
const handlePaymentIntentFailed = (0, ultraDebugLogger_1.traceFunction)(async (paymentIntent, database) => {
    try {
        ...
        ultraDebugLogger_1.ultraLogger.error("STRIPE_PAYMENT_FAILED", "Erreur traitement échec paiement", {
            error: failedError instanceof Error
                ? failedError.message
                : String(failedError),
...
const handlePaymentIntentCanceled = (0, ultraDebugLogger_1.traceFunction)(async (paymentIntent, database) => {
    try {
        ...
        ultraDebugLogger_1.ultraLogger.error("STRIPE_PAYMENT_CANCELED", "Erreur traitement annulation paiement", {
            error: canceledError instanceof Error
...
exports.scheduledFirestoreExport = (0, scheduler_1.onSchedule)({
    ...
    try {
        ...
        logFunctionEnd(metadata, undefined, exportError instanceof Error
            ? exportError
...
exports.scheduledCleanup = (0, scheduler_1.onSchedule)({
    ...
    try {
        ...
        logFunctionEnd(metadata, undefined, cleanupError instanceof Error
            ? cleanupError
...
var checkProviderInactivity_1 = require("./scheduled/checkProviderInactivity");
Object.defineProperty(exports, "checkProviderInactivity", { enumerable: true, get: function () { return checkProviderInactivity_1.checkProviderInactivity; } });
var updateProviderActivity_1 = require("./callables/updateProviderActivity");
