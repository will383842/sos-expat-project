...
const COUNTRY_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  'Myanmar': { fr: 'birmanie', en: 'myanmar', es: 'birmania', pt: 'myanmar', de: 'myanmar', it: 'myanmar', ru: 'myanma', el: 'mianmar', bg: 'mianmar' },
  'Birmanie': { fr: 'birmanie', en: 'myanmar', es: 'birmania', pt: 'myanmar', de: 'myanmar', it: 'myanmar', ru: 'myanma', el: 'mianmar', bg: 'mianmar' },
