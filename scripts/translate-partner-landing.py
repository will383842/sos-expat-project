...
TRANSLATIONS = {
    "en": {
        ...
        "partner.landing.v2.steps.title": "How it works in practice",
        "partner.landing.v2.steps.apply.title": "1. You tell us about your need",
        "partner.landing.v2.steps.apply.desc": "Get in touch. We'll talk soon to understand your organisation, your audience and your needs. No commitment.",
        "partner.landing.v2.steps.negotiate.title": "2. We formalise the agreement",
        "partner.landing.v2.steps.negotiate.desc": "Together we define the formula (per-member, flat fee, tiered or custom), the estimated volume, the onboarding modality and the commercial terms. Order Form, B2B Terms and DPA signed electronically.",
        "partner.landing.v2.steps.integrate.title": "3. You add your clients",
        "partner.landing.v2.steps.integrate.desc": "From your partner dashboard, you add your clients one by one, you import them via CSV or you sync your CRM through the REST API. SOS-Expat then automatically sends each client their activation email containing their personal access code.",
        "partner.landing.v2.steps.earn.title": "4. Your clients call in under 5 minutes",
        "partner.landing.v2.steps.earn.desc": "Your client visits their dedicated page, enters their access code, picks their lawyer or helping expat, and gets connected by phone in under 5 minutes. You track every call in real time on your dashboard and receive a single invoice at the end of the month.",
    },
    "es": {
        ...
        "partner.landing.v2.steps.title": "Cómo funciona, concretamente",
        "partner.landing.v2.steps.apply.title": "1. Nos cuenta su necesidad",
        "partner.landing.v2.steps.apply.desc": "Contáctenos. Hablamos pronto para entender su organización, su audiencia y sus necesidades. Sin compromiso.",
        "partner.landing.v2.steps.negotiate.title": "2. Formalizamos el acuerdo",
        "partner.landing.v2.steps.negotiate.desc": "Definimos juntos la fórmula (per-member, tarifa fija, escalonada o a medida), el volumen estimado, la modalidad de onboarding y las condiciones comerciales. Order Form, CGV B2B y DPA firmados electrónicamente.",
        "partner.landing.v2.steps.integrate.title": "3. Usted añade a sus clientes",
        "partner.landing.v2.steps.integrate.desc": "Desde su panel de socio, añade a sus clientes uno a uno, los importa por CSV o sincroniza su CRM mediante la API REST. SOS-Expat envía entonces automáticamente a cada cliente su email de activación con su código de acceso personal.",
        "partner.landing.v2.steps.earn.title": "4. Sus clientes llaman en menos de 5 minutos",
        "partner.landing.v2.steps.earn.desc": "Su cliente accede a su página dedicada, introduce su código de acceso, elige a su abogado o expatriado de apoyo, y queda en contacto telefónico en menos de 5 minutos. Usted sigue cada llamada en tiempo real desde su panel y recibe una factura única a fin de mes.",
    },
    "de": {
        ...
        "partner.landing.v2.steps.title": "So funktioniert es konkret",
        "partner.landing.v2.steps.apply.title": "1. Sie schildern uns Ihren Bedarf",
        "partner.landing.v2.steps.apply.desc": "Kontaktieren Sie uns. Wir sprechen kurzfristig, um Ihre Organisation, Ihr Publikum und Ihre Anforderungen zu verstehen. Ohne Verpflichtung.",
        "partner.landing.v2.steps.negotiate.title": "2. Wir formalisieren die Vereinbarung",
        "partner.landing.v2.steps.negotiate.desc": "Gemeinsam definieren wir die Formel (per-member, Pauschale, Staffel oder individuell), das geschätzte Volumen, die Onboarding-Modalität und die kommerziellen Bedingungen. Order Form, B2B-AGB und DPA werden elektronisch signiert.",
        "partner.landing.v2.steps.integrate.title": "3. Sie fügen Ihre Kunden hinzu",
        "partner.landing.v2.steps.integrate.desc": "Über Ihr Partner-Dashboard fügen Sie Ihre Kunden einzeln hinzu, importieren sie per CSV oder synchronisieren Ihr CRM über die REST-API. SOS-Expat sendet dann jedem Kunden automatisch seine Aktivierungs-E-Mail mit seinem persönlichen Zugangscode.",
        "partner.landing.v2.steps.earn.title": "4. Ihre Kunden rufen in unter 5 Minuten an",
        "partner.landing.v2.steps.earn.desc": "Ihr Kunde besucht seine dedizierte Seite, gibt seinen Zugangscode ein, wählt einen Anwalt oder einen helfenden Expat und wird in unter 5 Minuten telefonisch verbunden. Sie verfolgen jeden Anruf in Echtzeit in Ihrem Dashboard und erhalten eine einzige Rechnung zum Monatsende.",
    },
    "pt": {
        "partner.landing.v2.hero.highlight": "menos de 5 minutos",
        ...
        "partner.landing.v2.steps.title": "Como funciona, na prática",
        "partner.landing.v2.steps.apply.title": "1. Conta-nos a sua necessidade",
        "partner.landing.v2.steps.apply.desc": "Contacte-nos. Conversamos em breve para perceber a sua organização, o seu público e as suas necessidades. Sem compromisso.",
        "partner.landing.v2.steps.negotiate.title": "2. Formalizamos o acordo",
        "partner.landing.v2.steps.negotiate.desc": "Definimos juntos a fórmula (por membro, tarifa fixa, por escalões ou personalizada), o volume estimado, a modalidade de onboarding e as condições comerciais. Order Form, T&C B2B e DPA assinados eletronicamente.",
        "partner.landing.v2.steps.integrate.title": "3. Adiciona os seus clientes",
        "partner.landing.v2.steps.integrate.desc": "A partir do seu dashboard de parceiro, adiciona os seus clientes um a um, importa-os por CSV ou sincroniza o seu CRM através da API REST. A SOS-Expat envia então automaticamente a cada cliente o seu email de ativação com o seu código de acesso pessoal.",
        "partner.landing.v2.steps.earn.title": "4. Os seus clientes ligam em menos de 5 minutos",
        "partner.landing.v2.steps.earn.desc": "O seu cliente acede à sua página dedicada, introduz o seu código de acesso, escolhe o seu advogado ou expatriado de apoio, e fica em contacto telefónico em menos de 5 minutos. Acompanha cada chamada em tempo real no seu dashboard e recebe uma fatura única ao final do mês.",
    },
    "ar": {
        "partner.landing.v2.hero.highlight": "أقل من 5 دقائق",
        "partner.landing.v2.hero.title": "أينما كانوا في العالم، محامٍ يتحدث لغتهم خلال {highlight}",
        "partner.landing.v2.hero.subtitle": "امنحوا عملاءكم راحة البال أينما كانوا في العالم. سواء كانوا مسافرين أو مصطافين أو سيّاحاً أو رحّالة رقميين أو مغتربين أو طلاباً: لأي حاجة أو حالة طارئة في الخارج، يتواصلون هاتفياً مع محامٍ يتحدث لغتهم. أو مع مغترب محلي مساعد للإجراءات العملية. على مدار الساعة، طوال أيام السنة، بما فيها العطل الرسمية، في 197 دولة. عرض استثنائي يميّز علامتكم التجارية، دون أي عبء لوجستي على فرقكم.",
        ...
        "partner.landing.v2.profiles.subtitle": "كل مؤسسة على تواصل منتظم مع المسافرين أو المصطافين أو السيّاح أو الرحّالة الرقميين أو المغتربين أو الطلاب أو المهنيين المتنقلين دولياً، أينما كانوا في العالم. من منظم الرحلات إلى السفارة، ومن شركات التكنولوجيا المالية إلى لجان الموظفين.",
        ...
        "partner.landing.v2.faq.a5": "منظمو الرحلات، وكالات السفر، شركات الرحلات البحرية، خدمات الكونسيرج، لجان الموظفين، شركات تأمين السفر والاغتراب، السفارات، القنصليات، البنوك، شركات التكنولوجيا المالية، شركات التأمين التعاوني، شركات النقل والشحن، مكاتب الانتقال الدولي، مكاتب المحاماة، الاتحادات والجمعيات، المدارس الدولية، منصات الرحّالة الرقميين، الشركات والمجموعات الدولية. كل مؤسسة على تواصل منتظم مع المسافرين أو المصطافين أو السيّاح أو الرحّالة الرقميين أو المغتربين أو الطلاب أو المهنيين المتنقلين دولياً.",
        "partner.landing.v2.corporates.gdpr.title": "الامتثال الدولي",
        "partner.landing.v2.corporates.gdpr.desc": "اتفاقية معالجة البيانات الشخصية متوافقة مع GDPR (الاتحاد الأوروبي) و CCPA (كاليفورنيا) و LGPD (البرازيل) و PIPEDA (كندا) و POPIA (جنوب إفريقيا) و APP (أستراليا). استضافة متعددة المناطق، وسجل تدقيق متكامل، ومعالجون فرعيون محددون بوضوح. مصمَّم للإدارات القانونية ذات المتطلبات الصارمة أينما كانت في العالم.",
        ...
        "partner.landing.v2.steps.title": "كيف يعمل النظام عملياً",
        "partner.landing.v2.steps.apply.title": "1. تخبروننا باحتياجكم",
        "partner.landing.v2.steps.apply.desc": "تواصلوا معنا. سنتحدث قريباً لفهم مؤسستكم وجمهوركم واحتياجاتكم. دون أي التزام.",
        "partner.landing.v2.steps.negotiate.title": "2. نُبرم الاتفاقية",
        "partner.landing.v2.steps.negotiate.desc": "نحدد معاً الصيغة (per-member، رسوم ثابتة، شرائح أو مخصصة)، الحجم المقدّر، طريقة الإدراج والشروط التجارية. Order Form والشروط العامة B2B واتفاقية معالجة البيانات موقّعة إلكترونياً.",
        "partner.landing.v2.steps.integrate.title": "3. تضيفون عملاءكم",
        "partner.landing.v2.steps.integrate.desc": "من لوحة الشريك الخاصة بكم، تضيفون عملاءكم واحداً تلو الآخر، تستوردونهم عبر CSV أو تزامنون نظام CRM لديكم عبر REST API. عندئذٍ ترسل SOS-Expat تلقائياً لكل عميل بريد التفعيل المتضمن رمز الوصول الشخصي.",
        "partner.landing.v2.steps.earn.title": "4. عملاؤكم يتصلون خلال أقل من 5 دقائق",
        "partner.landing.v2.steps.earn.desc": "يدخل عميلكم إلى صفحته المخصصة، يُدخل رمز الوصول، يختار محاميه أو المغترب المساعد، ويُربَط هاتفياً خلال أقل من 5 دقائق. تتابعون كل اتصال في الوقت الفعلي على لوحتكم، وتستلمون فاتورة واحدة في نهاية الشهر.",
    },
    "ru": {
        ...
        "partner.landing.v2.steps.title": "Как это работает на практике",
        "partner.landing.v2.steps.apply.title": "1. Вы рассказываете нам о вашей потребности",
        "partner.landing.v2.steps.apply.desc": "Свяжитесь с нами. Мы поговорим в ближайшее время, чтобы понять вашу организацию, вашу аудиторию и ваши потребности. Без обязательств.",
        "partner.landing.v2.steps.negotiate.title": "2. Мы оформляем соглашение",
        "partner.landing.v2.steps.negotiate.desc": "Вместе определяем формулу (per-member, фиксированный тариф, ступени или индивидуально), оценочный объём, способ подключения и коммерческие условия. Order Form, B2B-условия и DPA подписываются электронно.",
        "partner.landing.v2.steps.integrate.title": "3. Вы добавляете ваших клиентов",
        "partner.landing.v2.steps.integrate.desc": "Из вашей партнёрской панели вы добавляете клиентов поодиночке, импортируете их по CSV или синхронизируете ваш CRM через REST API. SOS-Expat автоматически отправляет каждому клиенту его письмо активации с личным кодом доступа.",
        "partner.landing.v2.steps.earn.title": "4. Ваши клиенты звонят менее чем за 5 минут",
        "partner.landing.v2.steps.earn.desc": "Ваш клиент заходит на свою выделенную страницу, вводит код доступа, выбирает адвоката или экспата-помощника и за менее чем 5 минут соединяется по телефону. Вы отслеживаете каждый звонок в реальном времени в вашем дашборде и получаете единый счёт в конце месяца.",
    },
    "hi": {
        "partner.landing.v2.hero.highlight": "5 मिनट से भी कम में",
        "partner.landing.v2.hero.title": "वे दुनिया में जहाँ भी हों, उनकी भाषा बोलने वाला वकील {highlight}",
        "partner.landing.v2.hero.subtitle": "अपने ग्राहकों को निश्चिंतता दीजिए, वे दुनिया में जहाँ भी हों। यात्री हों या छुट्टी मनाने वाले, पर्यटक, डिजिटल नोमैड, प्रवासी या छात्र — विदेश में किसी भी ज़रूरत या आपात स्थिति में वे फ़ोन पर अपनी भाषा बोलने वाले वकील से जुड़ते हैं। या व्यावहारिक कामों के लिए स्थानीय सहायक प्रवासी से। 24 घंटे, सातों दिन, साल के 365 दिन, छुट्टियाँ भी शामिल, 197 देशों में। एक असाधारण पेशकश जो आपके ब्रांड को विशिष्ट बनाती है — आपकी टीमों पर कोई बोझ डाले बिना।",
        ...
        "partner.landing.v2.profiles.subtitle": "हर वह संगठन जो यात्रियों, छुट्टी मनाने वालों, पर्यटकों, डिजिटल नोमैड, प्रवासियों, छात्रों या अंतर्राष्ट्रीय रूप से कार्यरत पेशेवरों के नियमित संपर्क में हो — दुनिया में कहीं भी। टूर ऑपरेटर से लेकर दूतावास तक, फिनटेक से लेकर कर्मचारी समिति तक।",
        ...
        "partner.landing.v2.advantages.widget.desc": "आपके हर ग्राहक को अपने आप एक ईमेल मिल जाता है जिसमें उसका व्यक्तिगत एक्सेस कोड और कॉल करने का लिंक होता है। आपके ब्रांड के अनुसार पूरी तरह अनुकूलनीय टेम्पलेट, 9 भाषाओं में।",
        ...
        "partner.landing.v2.steps.title": "यह व्यावहारिक रूप से कैसे काम करता है",
        "partner.landing.v2.steps.apply.title": "1. आप हमें अपनी ज़रूरत बताते हैं",
        "partner.landing.v2.steps.apply.desc": "हमसे संपर्क करें। हम जल्द ही आपसे बात करेंगे ताकि आपके संगठन, आपके दर्शकों और आपकी ज़रूरतों को समझ सकें। कोई प्रतिबद्धता नहीं।",
        "partner.landing.v2.steps.negotiate.title": "2. हम समझौते को औपचारिक रूप देते हैं",
        "partner.landing.v2.steps.negotiate.desc": "हम साथ मिलकर फ़ॉर्मूला (per-member, फ़्लैट शुल्क, चरणबद्ध या कस्टम), अनुमानित मात्रा, ऑनबोर्डिंग का तरीक़ा और वाणिज्यिक शर्तें तय करते हैं। Order Form, B2B शर्तें और DPA इलेक्ट्रॉनिक रूप से हस्ताक्षरित।",
        "partner.landing.v2.steps.integrate.title": "3. आप अपने ग्राहक जोड़ते हैं",
        "partner.landing.v2.steps.integrate.desc": "अपने पार्टनर डैशबोर्ड से, आप अपने ग्राहकों को एक-एक करके जोड़ते हैं, उन्हें CSV द्वारा आयात करते हैं या REST API के माध्यम से अपने CRM से सिंक्रोनाइज़ करते हैं। SOS-Expat तब हर ग्राहक को स्वचालित रूप से उसके व्यक्तिगत एक्सेस कोड के साथ एक्टिवेशन ईमेल भेजता है।",
        "partner.landing.v2.steps.earn.title": "4. आपके ग्राहक 5 मिनट से भी कम में कॉल करते हैं",
        "partner.landing.v2.steps.earn.desc": "आपका ग्राहक अपने समर्पित पेज पर जाता है, अपना एक्सेस कोड दर्ज करता है, अपना वकील या सहायक प्रवासी चुनता है, और 5 मिनट से भी कम में फ़ोन पर जुड़ जाता है। आप हर कॉल को रियल-टाइम में अपने डैशबोर्ड पर ट्रैक करते हैं और महीने के अंत में एक ही चालान प्राप्त करते हैं।",
    },
    "ch": {
        "partner.landing.v2.hero.highlight": "5 分钟",
        "partner.landing.v2.hero.title": "无论身在世界何处,{highlight}内为客户接通讲他们语言的律师",
        "partner.landing.v2.hero.subtitle": "让您的客户无论身在世界何处,都能拥有一份安心。旅行者、度假者、游客、数字游民、外籍人士、学生 —— 无论在海外遇到任何需求或紧急情况,他们都能通过电话在数分钟内联系到一位说他们母语的律师,或一位提供实务协助的当地外籍人士。全天候 24 小时、一周 7 天、全年 365 天(含节假日)运转,覆盖 197 个国家。一项独特的服务,让您的品牌脱颖而出,且无需贵团队承担任何运营负担。",
        ...
        "partner.landing.v2.profiles.subtitle": "任何与旅行者、度假者、游客、数字游民、外籍人士、学生或跨国派驻专业人员保持长期联系的机构,遍及全球。从旅游运营商到大使馆,从金融科技公司到企业员工委员会,皆可加入。",
        ...
        "partner.landing.v2.steps.title": "实际运作流程",
        "partner.landing.v2.steps.apply.title": "1. 您告诉我们您的需求",
        "partner.landing.v2.steps.apply.desc": "联系我们。我们很快就会沟通,了解贵机构、贵客群和贵方需求。无任何约束。",
        "partner.landing.v2.steps.negotiate.title": "2. 我们正式签订协议",
        "partner.landing.v2.steps.negotiate.desc": "我们共同确定方案模式(per-member 按人计费、固定套餐、阶梯式或定制)、预估业务量、客户接入方式及商业条款。Order Form、B2B 合同条款及 DPA 通过电子方式签署。",
        "partner.landing.v2.steps.integrate.title": "3. 您添加客户",
        "partner.landing.v2.steps.integrate.desc": "从您的合作伙伴仪表盘,您可以逐个添加客户、通过 CSV 导入,或经由 REST API 与您的 CRM 同步。SOS-Expat 随后自动向每位客户发送包含其个人访问代码的激活邮件。",
        "partner.landing.v2.steps.earn.title": "4. 您的客户在 5 分钟内接通电话",
        "partner.landing.v2.steps.earn.desc": "您的客户进入其专属页面,输入访问代码,选择律师或协助外籍人士,在 5 分钟内通过电话接通。您可在仪表盘上实时追踪每一通电话,并在月末收到一张统一发票。",
    },
}
