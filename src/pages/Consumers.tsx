...
4.1. **الدعم عبر النموذج**: http://localhost:5174/contact  
...
5.3. **اتصل**: استخدم **نموذج الاتصال** المخصص: http://localhost:5174/contact

---

## 6. اتصل

نموذج الاتصال (الدعم والطلبات القانونية): http://localhost:5174/contact
`;
