...
const TermsExpats: React.FC = () => {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState<'fr' | 'en' | 'es' | 'de' | 'ru' | 'hi' | 'ch' | 'pt' | 'ar'>(
...
pt: {
  ...
  sections: {
    ...
    scope: "Objeto, âmbito e aceitação",
    status: "Status do Ajudante Conformidade e responsabilidades",
    account: "Conta, verificações e segurança",
    rules: "Regras de uso Qualidade, proibições, não evasão",
    relationship: "Relação AjudanteUsuário fora da plataforma",
    fees: "Taxas, pagamento único e impostos",
    data: "Dados pessoais estrutura global",
    ip: "Propriedade intelectual",
    liability: "Garantias, responsabilidade e indenização",
    law: "Lei aplicável Arbitragem Jurisdição estoniana",
    misc: "Diversos",
    contact: "Contato",
  },
  ...
  anchorTitle: "Resumo",
  editHint: "Documento editável no console de administração",
...
ar: {
  ...
  trustedByHelpers: "أكثر من 1000 مساعد مغترب يثقون بنا بالفعل",
  ...
  sections: {
    ...
    rules: "قواعد الاستخدام الجودة، المحظورات، عدم التحايل",
    ...
    law: "القانون الحاكم التحكيم المحاكم الإستونية",
    misc: "متفرقات",
    contact: "اتصل",
  },
  ...
  const handleLanguageChange = (newLang: 'fr' | 'en' | 'es' | 'de' | 'ru' | 'hi' | 'ch' | 'ar' | 'pt') => {
...
`
  ...
  const defaultPt = `SOS Expat by Ulixai – O a Plataforma, SOS, nós
Versão 2.2 – Última atualização: 16 de junho de 2025

--- TITLE Termos de Uso Ajudantes de Expatriados Global

Ajudante significa qualquer pessoa registrada na Plataforma para oferecer, de forma independente, serviços de assistência não legal e não médica aos Usuários – orientação, tarefas práticas, tradução informal, introduções locais, etc.

Usuário significa qualquer pessoa que utiliza a Plataforma para contatar um Ajudante.

Conexão significa a introdução técnica–operacional que permite compartilhar detalhes, iniciar uma chamada/mensagem/vídeo e/ou aceitação por parte do Ajudante.

País de Intervenção significa a jurisdição principalmente visada pela solicitação do Usuário no momento da Conexão.

Tarifa de Conexão significa EUR 19 se pago em EUR ou USD 25 se pago em USD, sujeita a alterações e/ou cronogramas locais por país/moeda, com efeito prospectivo.

Processadores de Pagamento são serviços terceirizados que processam cobranças e pagamentos.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 1. Definições

2.1. Os presentes Termos regem o acesso e uso da Plataforma pelos Ajudantes.

2.2. Ulixai atua exclusivamente como intermediário técnico de Conexão. Ulixai não é empregador, mandatário ou parceiro dos Ajudantes, não fornece aconselhamento jurídico, médico, fiscal, contábil ou regulado, e não é parte em contratos entre Ajudantes e Usuários.

2.3. Aceitação eletrônica (click-wrap). O registro e/ou uso da Plataforma significam aceitação dos Termos, assinatura eletrônica e consentimento contratual. SOS pode manter provas técnicas – data/hora, identificadores.

2.4. Modificações. SOS pode atualizar os Termos e/ou cronogramas de tarifas por país/moeda com efeito prospectivo mediante publicação na Plataforma. O uso contínuo significa aceitação.

2.5. Capacidade profissional (B2B). O Ajudante declara agir exclusivamente para fins profissionais – os regimes de proteção do consumidor não se aplicam à relação Ulixai–Ajudante.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 2. Objetivo, Âmbito e Aceitação

3.1. Independência. O Ajudante atua como profissional independente – nenhuma relação de emprego, mandato, agência, parceria ou empreendimento conjunto é criada com Ulixai.

3.2. Autorização de trabalho/imigração. O Ajudante é exclusivamente responsável por obter e manter todas as autorizações necessárias em cada País de Intervenção – visto, permissão de trabalho, registro de atividade/autônomo, seguros, licenças locais, etc. Ulixai não verifica essas autorizações e não assume responsabilidade.

3.3. Serviços regulados. O Ajudante não fornecerá serviços regulados – ex. aconselhamento jurídico, médico, financeiro, contábil, imobiliário, etc. – sem deter as autorizações/licenças necessárias e sem cumprir totalmente as leis locais. Do contrário, o Ajudante deverá abster-se e redirecionar o Usuário para um profissional devidamente habilitado.

3.4. Conformidade geral. O Ajudante respeita as leis aplicáveis – consumo, e-commerce, publicidade/angariação, concorrência leal, AML-CFT onde relevante, fiscalidade, proteção de dados, sanções/exportação, segurança pessoal.

3.5. Seguros. O Ajudante declara manter seguros apropriados – responsabilidade civil profissional – cobrindo suas atividades e territórios de intervenção.

3.6. Confidencialidade. O Ajudante protege informações dos Usuários e se abstém de divulgá-las, exceto por exigência legal ou consentimento.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 3. Status do Ajudante – Conformidade, Autorizações e Responsabilidades

4.1. Registro. Um account por Ajudante – informações exatas, completas e atualizadas: identidade, meios de contato, descrição de serviços, zonas de intervenção, etc.

4.2. Verificações. Ulixai pode conduzir verificações razoáveis – identidade, coerência de perfil, screenings de sanções/KYC via processadores – e pode recusar/suspender/retirar acesso por motivos de segurança, conformidade ou qualidade de serviço.

4.3. Segurança de acesso. O Ajudante protege seus identificadores. Toda atividade via account é presumida como realizada por ele.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 4. Conta, Verificações e Segurança

5.1. Descrição precisa – sem status profissional falso, sem promessas de resultado.

5.2. Proibições. Conteúdo ilícito/discriminatório/enganoso – práticas desleais – coleta/uso abusivo de dados – engenharia reversa da Plataforma – colusão/boicote – violações de sanções/exportação – qualquer atividade ilegal.

5.3. Sem contornamento. Cada nova Conexão com um novo Usuário via Plataforma gera a Tarifa de Conexão. É proibido evitar essas tarifas contornando a Plataforma.

5.4. Disponibilidade. A Plataforma é fornecida no estado atual – nenhuma disponibilidade contínua é garantida – manutenção, incidentes, força maior. O acesso pode ser restrito se a lei exigir.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 5. Regras de Uso – Qualidade, Condutas Proibidas, Sem Contornamento

6.1. Após a Conexão, o Ajudante e o Usuário podem contratar fora da Plataforma. Honorários e termos são definidos livremente, respeitando as leis locais.

6.2. O Ajudante fornece confirmações/termos de serviço em conformidade com a lei local, gerencia sua faturação e obrigações fiscais.

6.3. Ulixai não é responsável pela qualidade, exatidão ou resultado dos serviços do Ajudante, nem pelos compromissos entre Ajudante e Usuário.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 6. Relação Ajudante–Usuário (Fora da Plataforma)

7.1. Tarifa de Conexão (valor fixo). EUR 19 ou USD 25 por Conexão, excluindo impostos e taxas do processador. Ulixai pode alterar esses valores e/ou publicar cronogramas locais por país/moeda com efeito prospectivo.

7.2. Pagamento único – repartição. O Usuário efetua um pagamento único via Plataforma cobrindo: (i) a remuneração do Ajudante conforme acordado e (ii) a Tarifa de Conexão de Ulixai. Ulixai ou seu processador coleta, deduz sua tarifa, depois repassa o restante ao Ajudante, quem autoriza tais deduções.

7.3. Exigibilidade – não reembolsável. A Tarifa de Conexão é devida na Conexão e é não reembolsável, exceto por gesto discricionário de Ulixai em caso de falha exclusivamente imputável à Plataforma, na medida permitida pela lei.

7.4. Reembolsos do Usuário. Se um reembolso for concedido ao Usuário, é imputado à parcela do Ajudante – Ulixai pode reter/compensar o valor em futuros pagamentos ao Ajudante ou solicitar reembolso se nenhum pagamento for devido.

7.5. Moedas – conversão. Múltiplas moedas podem ser oferecidas – taxas/taxas de conversão do processador podem se aplicar.

7.6. Impostos. O Ajudante permanece responsável por todos os impostos aplicáveis – IVA, imposto de renda, seguridade social, etc. Ulixai coleta/repassa IVA ou equivalente local sobre as Tarifas de Conexão quando exigido.

7.7. Compensação. Ulixai pode compensar qualquer montante devido pelo Ajudante com qualquer montante pagável ao Ajudante.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 7. Tarifas, Pagamento Único e Impostos

8.1. Funções. Para dados de Usuários recebidos para Conexão, Ulixai e o Ajudante atuam cada um como controlador independente para seus próprios fins.

8.2. Bases legais/fins. Execução de contrato (Conexão), interesses legítimos (segurança, prevenção de fraude, melhoria), conformidade legal (AML-FT, sanções), e consentimento quando aplicável.

8.3. Transferências internacionais com garantias apropriadas quando exigido.

8.4. Direitos. Exercício via formulário de contato da Plataforma.

8.5. Segurança. Medidas técnicas/organizacionais razoáveis – notificação de violações conforme as leis aplicáveis.

8.6. O Ajudante processa dados em conformidade com a lei do País de Intervenção.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 8. Dados Pessoais (Estrutura Global)

A Plataforma, suas marcas, logos, bancos de dados e conteúdos são protegidos. Nenhum direito é transferido ao Ajudante, exceto um direito pessoal, não exclusivo, não transferível de acesso durante a vigência dos Termos. Conteúdos fornecidos pelo Ajudante são licenciados mundialmente, de forma não exclusiva, a Ulixai para hospedagem e exibição na Plataforma.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 9. Propriedade Intelectual

10.1. Nenhuma garantia quanto a resultados/qualidade/volume de negócios – Plataforma fornecida no estado atual.

10.2. Limitação de responsabilidade. Na medida permitida, a responsabilidade total de Ulixai para com o Ajudante é limitada a danos diretos e não pode exceder o total das Tarifas de Conexão cobradas por Ulixai pela transação que originou a reclamação.

10.3. Exclusões. Sem danos indiretos/consequenciais/especiais/punitivos – perda de lucros, oportunidades, clientela, danos à reputação, custos de reposição, etc.

10.4. Indenização. O Ajudante indeniza e exime Ulixai, bem como suas afiliadas, dirigentes, funcionários, agentes de qualquer reclamação, perda, dano, penalidade e custos (incluindo honorários advocatícios) decorrentes de: (i) violação dos Termos/leis, (ii) conteúdos do Ajudante, (iii) serviços/omissões do Ajudante, (iv) falta de autorizações de trabalho/imigração/licenças.

10.5. Nenhuma representação. Nada implica mandato, emprego, parceria ou empreendimento conjunto entre Ulixai e o Ajudante.

10.6. Sobrevivência. Os Artigos 5, 7, 8, 9, 10, 11 e 12 sobrevivem à rescisão.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 10. Garantias, Responsabilidade e Indenização

11.1. Direito material. Para cada Conexão, a relação Ulixai–Ajudante é regida pelas leis do País de Intervenção, sujeito às regras de ordem pública local e às normas internacionais imperativas. Como complemento e para interpretação/validade dos presentes Termos e para questões não regidas pela lei do País de Intervenção, aplica-se a lei estoniana.

11.2. Arbitragem ICC obrigatória. Qualquer litígio Ulixai–Ajudante é resolvido definitivamente conforme as Regras de Arbitragem da ICC. Sede: Tallinn, Estônia. Idioma: Português. O tribunal aplica o direito material definido no Artigo 11.1. Procedimento confidencial.

11.3. Renúncia a ações coletivas. Na medida permitida, qualquer ação coletiva/de grupo/representativa é excluída – apenas reclamações individuais.

11.4. Competência exclusiva dos tribunais estonios. Para qualquer demanda não arbitrável, execução de sentenças ou medidas urgentes, os tribunais estonios com competência em Tallinn têm competência exclusiva. O Ajudante renuncia a objeções de forum/forum non conveniens.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 11. Lei Aplicável – Arbitragem ICC – Jurisdição Estoniana – Ações Coletivas

12.1. Cessão. Ulixai pode ceder os Termos a uma entidade de seu grupo ou sucessor – o Ajudante não pode ceder sem consentimento escrito de Ulixai.

12.2. Acordo integral. Os Termos constituem o acordo completo e substituem qualquer acordo anterior sobre o mesmo objeto.

12.3. Notificações. Por publicação na Plataforma, notificação no-app ou via formulário de contato.

12.4. Interpretação. Os títulos são indicativos. Nenhuma regra contra proferentem.

12.5. Idiomas. Traduções podem ser fornecidas – Português prevalece para interpretação.

12.6. Nulidade parcial. Se qualquer disposição for nula/inaplicável, o restante permanece em vigor – substituível por disposição válida de efeito equivalente quando possível.

12.7. Não renúncia. A não execução de um direito não implica renúncia.

--- TITLE Termos de Uso Ajudantes de Expatriados Global - 12. Diversos

Para qualquer pergunta ou solicitação legal, entre em contato conosco`;

const defaultAr = `SOS Expat by Ulixai – المنصة، SOS، نحن
الإصدار 2.2 – آخر تحديث: 16 يونيو 2025

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية
...
الاتصال يعني التقديم التقني-التشغيلي الذي يسمح بمشاركة التفاصيل وبدء مكالمة/رسالة/فيديو و/أو قبول المساعد.

دولة التدخل تعني الاختصاص القضائي الذي تستهدفه بشكل أساسي طلب المستخدم في وقت الاتصال.

رسم الاتصال يعني EUR 19 إذا تم الدفع بـ EUR أو USD 25 إذا تم الدفع بـ USD، وهو عرضة للتغيير و/أو جداول محلية حسب البلد/العملة بتأثير مستقبلي.

معالجات الدفع هي خدمات من جهات خارجية تتعامل مع التحصيل والسحب.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 1. التعريفات

2.1. تحكم هذه الشروط الوصول واستخدام المنصة من قبل المساعدين.

2.2. تعمل Ulixai حصريًا كوسيط تقني للاتصال. Ulixai ليست صاحب عمل أو وكيل أو شريك للمساعدين، ولا تقدم مشورة قانونية أو طبية أو ضريبية أو محاسبية أو منظمة، وليست طرفًا في العقود بين المساعدين والمستخدمين.

2.3. القبول الإلكتروني (click-wrap). التسجيل و/أو استخدام المنصة يعني قبول الشروط والتوقيع الإلكتروني والموافقة على العقد. قد تحتفظ SOS بالأدلة التقنية – الطابع الزمني والمعرّفات.

2.4. التعديلات. قد تحدّث SOS الشروط و/أو جداول الرسوم حسب البلد/العملة بتأثير مستقبلي عند النشر على المنصة. الاستخدام المستمر يعني القبول.

2.5. القدرة المهنية (B2B). يعلن المساعد أنه يتصرف حصريًا لأغراض مهنية – لا تنطبق أنظمة حماية المستهلك على علاقة Ulixai–المساعد.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 2. الهدف والنطاق والقبول

3.1. الاستقلالية. يعمل المساعد كمهني مستقل – لا تُنشأ أي علاقة عمل أو وكالة أو شراكة أو مشروع مشترك مع Ulixai.

3.2. تصريح العمل/الهجرة. المساعد مسؤول حصريًا عن الحصول على الحفاظ على جميع التصاريح المطلوبة في كل دولة تدخل – تأشيرة وتصريح عمل وتسجيل نشاط/عامل حر وتأمين وتراخيص محلية وغيرها. Ulixai لا تتحقق من هذه التصاريح ولا تتحمل أي مسؤولية.

3.3. الخدمات المنظمة. لن يقدم المساعد خدمات منظمة – مثل الاستشارات القانونية أو الطبية أو المالية أو المحاسبية أو وسيط العقارات وغيرها – دون امتلاك التصاريح/التراخيص الضرورية وبدون الامتثال الكامل للقانون المحلي. وإلا، يجب على المساعد الامتناع وإعادة توجيه المستخدم إلى متخصص مرخص بشكل صحيح.

3.4. الامتثال العام. يمتثل المساعد للقوانين المعمول بها – الاستهلاك والتجارة الإلكترونية والإعلان/الاستفسار والمنافسة النزيهة وAML-CFT حيث ينطبق والضرائب وحماية البيانات والعقوبات/التصدير والسلامة الشخصية.

3.5. التأمين. يعلن المساعد عن الحفاظ على التأمين المناسب – المسؤولية المدنية المهنية – يغطي أنشطته وأراضي التدخل.

3.6. السرية. يحمي المساعد معلومات المستخدمين ويمتنع عن الكشف عنها، إلا بموجب متطلب قانوني أو موافقة.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 3. حالة المساعد – الامتثال والتصاريح والمسؤوليات

4.1. التسجيل. حساب واحد لكل مساعد – معلومات دقيقة وكاملة ومحدثة: الهوية ووسائل الاتصال ووصف الخدمات ومناطق التدخل وغيرها.

4.2. التحقق. قد تجري Ulixai تحققات معقولة – الهوية واتساق الملف الشخصي وفحوصات العقوبات/KYC عبر معالجات – وقد ترفض/توقف/تسحب الوصول لأسباب الأمان أو الامتثال أو جودة الخدمة.

4.3. أمان الوصول. يحمي المساعد معرّفاته. يُفترض أن جميع الأنشطة عبر الحساب تتم به.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 4. الحساب والتحقق والأمان

5.1. الوصف الدقيق – بدون حالة مهنية كاذبة وبدون وعود بالنتائج.

5.2. الحظر. المحتوى غير القانوني/التمييزي/المضلل – الممارسات غير النزيهة – جمع/الاستخدام السيء للبيانات – الهندسة العكسية للمنصة – التواطؤ/المقاطعة – انتهاكات العقوبات/التصدير – أي نشاط غير قانوني.

5.3. بدون التفافية. يؤدي كل اتصال جديد مع مستخدم جديد عبر المنصة إلى رسم الاتصال. من المحظور تجنب هذه الرسوم بالالتفاف حول المنصة.

5.4. التوفر. المنصة مقدمة كما هي – لا يتم ضمان أي توفر مستمر – الصيانة والحوادث والقوة القاهرة. قد يتم تقييد الوصول إذا تطلبت القانون ذلك.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 5. قواعد الاستخدام – الجودة والسلوك المحظور وبدون التفافية

6.1. بعد الاتصال، قد يبرم المساعد والمستخدم عقودًا خارج المنصة. يتم تحديد الرسوم والشروط بحرية مع احترام القوانين المحلية.

6.2. يقدم المساعد تأكيدات/شروط الخدمة بما يتفق مع القانون المحلي ويدير فواتيره والتزاماته الضريبية.

6.3. Ulixai غير مسؤولة عن جودة أو دقة أو نتائج خدمات المساعد، ولا عن الالتزامات بين المساعد والمستخدم.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 6. علاقة المساعد–المستخدم (خارج المنصة)

7.1. رسم الاتصال (المبلغ الثابت). EUR 19 أو USD 25 لكل اتصال، استبعاد الضرائب ورسوم المعالج. قد تغير Ulixai هذه المبالغ و/أو تنشر جداول محلية حسب البلد/العملة بتأثير مستقبلي.

7.2. الدفع الواحد – التقسيم. يقوم المستخدم بدفعة واحدة عبر المنصة تغطي: (i) تعويض المساعد حسب الاتفاق و(ii) رسم الاتصال Ulixai. تجمع Ulixai أو معالجها وتخصم رسومها ثم تحول الباقي للمساعد، الذي يأذن بهذه الخصومات.

7.3. الاستحقاق – غير قابل للاسترجاع. رسم الاتصال مستحق عند الاتصال وغير قابل للاسترجاع، باستثناء إيماءة تقديرية من Ulixai في حالة الفشل الذي تسبب به المنصة حصريًا، في الحدود المسموح بها بالقانون.

7.4. استرجاع المستخدم. إذا تم منح المستخدم استرجاع، يتم تحميله على حصة المساعد – قد تحتفظ Ulixai/تعوض المبلغ من الدفعات المستقبلية للمساعد أو تطلب السداد إذا لم تكن هناك دفعات مستحقة.

7.5. العملات – التحويل. قد يتم تقديم عملات متعددة – قد تنطبق معدلات/رسوم التحويل من المعالج.

7.6. الضرائب. يبقى المساعد مسؤولاً عن جميع الضرائب المعمول بها – IVA والدخل والضمان الاجتماعي وغيرها. تجمع Ulixai/تحول IVA أو ما يعادله محليًا على رسوم الاتصال عند الضرورة.

7.7. المقاصة. قد تقاصي Ulixai أي مبلغ مستحق من المساعد بأي مبلغ يدفع للمساعد.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 7. الرسوم والدفع الواحد والضرائب

8.1. الأدوار. لبيانات المستخدم المستلمة للاتصال، تعمل Ulixai والمساعد كل واحد منهما كمراقب مستقل لأغراضهما الخاصة.

8.2. القواعس القانونية/الأغراض. تنفيذ العقد (الاتصال) والمصالح المشروعة (الأمان ومنع الاحتيال والتحسين) والامتثال القانوني (AML-CFT والعقوبات) والموافقة عند الانطباق.

8.3. التحويلات الدولية مع ضمانات مناسبة عند الحاجة.

8.4. الحقوق. الممارسة عبر نموذج الاتصال بالمنصة.

8.5. الأمان. تدابير تقنية/تنظيمية معقولة – الإخطار بالانتهاكات حسب القوانين المعمول بها.

8.6. يقوم المساعد بمعالجة البيانات وفقًا لقانون دولة التدخل.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 8. حماية البيانات (الإطار العالمي)

المنصة وعلاماتها التجارية وشعاراتها وقواعد بياناتها ومحتوياتها محمية. لا يتم نقل أي حقوق للمساعد، باستثناء حق شخصي غير حصري غير قابل للتحويل للوصول أثناء هذه الشروط. محتوى المساعد مرخص عالميًا بشكل غير حصري لـ Ulixai للاستضافة والعرض على المنصة.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 9. الملكية الفكرية

10.1. لا يوجد ضمان بشأن النتائج/الجودة/حجم الأعمال – المنصة مقدمة كما هي.

10.2. تحديد المسؤولية. في الحدود المسموح بها، تقتصر المسؤولية الكلية لـ Ulixai تجاه المساعد على الأضرار المباشرة ولا يمكن أن تتجاوز إجمالي رسوم الاتصال المتقاضاة من قبل Ulixai للمعاملة التي أدت إلى المطالبة.

10.3. الاستثناءات. بدون أضرار غير مباشرة/تبعية/خاصة/عقابية – فقدان الأرباح والفرص والعملاء والأضرار على السمعة وتكاليف الاستبدال وغيرها.

10.4. التعويض. يعوض المساعد ويحصن Ulixai وكذلك فروعها والمديرين والموظفين والوكلاء ضد أي مطالبة أو خسارة أو ضرر أو عقوبة وتكاليف (بما فيها أتعاب المحامين المعقولة) الناشئة عن: (i) انتهاك الشروط/القوانين، (ii) محتويات المساعد، (iii) خدمات/حذف المساعد، (iv) عدم وجود تصاريح عمل/هجرة/تراخيص.

10.5. لا يوجد تمثيل. لا شيء يتضمن وكالة أو عمل أو شراكة أو مشروع مشترك بين Ulixai والمساعد.

10.6. البقاء. تبقى المواد 5 و7 و8 و9 و10 و11 و12 سارية بعد الإنهاء.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 10. الضمانات والمسؤولية والتعويض

11.1. القانون الموضوعي. لكل اتصال، تحكم علاقة Ulixai–المساعد قوانين دولة التدخل، وتخضع لقواعس النظام العام المحلية والمعايير الدولية الآمرة. بشكل تكميلي وللتفسير/الصحة من هذه الشروط وللمسائل التي لا تحكمها قوانين دولة التدخل، ينطبق القانون الإستوني.

11.2. التحكيم ICC الإلزامي. يتم تسوية أي نزاع Ulixai–المساعد بشكل نهائي وفقًا لقواعد ICC للتحكيم. المقر: تالين، إستونيا. اللغة: العربية. يطبق المحكمة القانون الموضوعي المحدد في المادة 11.1. الإجراء سري.

11.3. التنازل عن الإجراءات الجماعية. في الحدود المسموح بها، تُستبعد أي إجراءات جماعية/مجموعة/تمثيلية – فقط المطالبات الفردية.

11.4. الاختصاص الحصري لمحاكم إستونيا. لأي قضية غير قابلة للتحكيم أو تنفيذ أحكام أو تدابير عاجلة، للمحاكم الإستونية ذات الاختصاص في تالين الاختصاص الحصري. يتنازل المساعد عن الاعتراضات على المحكمة.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 11. القانون الحاكم والتحكيم ICC واختصاص إستونيا والإجراءات الجماعية

12.1. التنازل. قد تتنازل Ulixai عن الشروط لكيان من مجموعتها أو خليفة – لا يمكن للمساعد التنازل بدون موافقة كتابية من Ulixai.

12.2. الاتفاق الكامل. تشكل الشروط الاتفاق الكامل وتحل محل أي اتفاق سابق على نفس الموضوع.

12.3. الإخطارات. بالنشر على المنصة أو الإخطار داخل التطبيق أو عبر نموذج الاتصال.

12.4. التفسير. الرؤوس مؤشر. لا توجد قاعدة معارضة proferentem.

12.5. اللغات. قد يتم توفير الترجمات – العربية تسود للتفسير.

12.6. العطل الجزئي. إذا كانت أي نص باطل/غير قابل للتطبيق، فإن الباقي يبقى ساريًا – قابل للاستبدال بنص صحيح بتأثير مكافئ عند الإمكان.

12.7. عدم التنازل. عدم الممارسة لا يعني تنازلاً.

--- TITLE شروط الاستخدام مساعدي المغتربين العالمية - 12. متفرقات
...
لأي أسئلة أو طلبات قانونية، يرجى الاتصال بنا`;
  ...
  selectedLanguage === 'hi' ? defaultHi :
              ...
              selectedLanguage === 'pt' ? defaultPt :
              selectedLanguage === 'ar' ? defaultAr :
  defaultEn;
