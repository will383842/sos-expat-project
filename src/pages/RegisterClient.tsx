...
const RegisterClient: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setMeta('name', 'description', intl.formatMessage({ id: 'registerClient.meta.description' }));
    setMeta('name', 'keywords', intl.formatMessage({ id: 'registerClient.meta.keywords' }));
    setMeta('property', 'og:title', intl.formatMessage({ id: 'registerClient.meta.title' }));
    setMeta('property', 'og:description', intl.formatMessage({ id: 'registerClient.meta.description' }));
    setMeta('property', 'og:type', 'website');
    setMeta('property', 'og:locale', language === 'en' ? 'en_US' : 'fr_FR');
    setMeta('name', 'twitter:card', 'summary_large_image');
    setMeta('name', 'twitter:title', intl.formatMessage({ id: 'registerClient.meta.title' }));
    setMeta('name', 'twitter:description', intl.formatMessage({ id: 'registerClient.meta.description' }));
    ...
    const jsonld = {
      ...
      description: intl.formatMessage({ id: 'registerClient.meta.description' }),
      ...
      switch (fieldName) {
        case 'firstName':
          if (!value || (typeof value === 'string' && !value.trim())) {
            ...
            errors.firstName = intl.formatMessage({ id: 'registerClient.errors.firstNameTooShort' });
            validation.firstName = false;
          } else {
        ...
        case 'email':
          if (!value || (typeof value === 'string' && !value.trim())) {
            errors.email = intl.formatMessage({ id: 'registerClient.errors.emailRequired' });
        ...
        case 'password':
          if (!value) {
            errors.password = intl.formatMessage({ id: 'registerClient.errors.passwordRequired' });
        ...
        case 'terms':
          if (!value) {
            errors.terms = intl.formatMessage({ id: 'registerClient.errors.termsRequired' });
    ...
    (errorCode: string, originalMessage?: string): string => {
      switch (errorCode) {
        case 'auth/email-already-in-use':
          return intl.formatMessage({ id: 'registerClient.errors.emailAlreadyExists' });
        case 'sos/email-linked-to-google':
          return 'Cet email est lié à un compte Google. Utilisez "Se connecter avec Google".';
        case 'auth/network-request-failed':
          return intl.formatMessage({ id: 'registerClient.errors.networkError' });
        case 'auth/too-many-requests':
          return intl.formatMessage({ id: 'registerClient.errors.tooManyRequests' });
        ...
        default:
          ...
          return intl.formatMessage({ id: 'registerClient.errors.registrationError' });
      }
    },
    [intl]
  );
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        aria-label={intl.formatMessage({ 
                          id: showPassword ? 'registerClient.ui.ariaHidePassword' : 'registerClient.ui.ariaShowPassword' 
                        })}
                      >
                    ...
                    <PasswordStrengthBar 
                      ...
                      label={intl.formatMessage({ id: 'registerClient.ui.passwordStrength' })} 
                    />
                  ...
                  <div>
                    ...
                    {showCustomLanguage && (
                      <CustomFieldInput
                        placeholder={intl.formatMessage({ id: 'registerClient.actions.specifyLanguage' })}
                        ...
                        addLabel={intl.formatMessage({ id: 'registerClient.actions.add' })}
                      />
                    )}
                    ...
                    <div className="mt-3 flex items-center gap-2 text-xs text-gray-700 bg-blue-50 rounded-lg px-2 py-1 border border-blue-200">
                      ...
                      <span>
                        🔒 SSL • <FormattedMessage id="registerClient.help.dataSecure" />
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div className={`flex items-center gap-1 transition-colors ${fieldValidation.firstName ? 'text-green-600' : 'text-gray-400'}`}>
                        ...
                        <span><FormattedMessage id="registerClient.fields.firstName" /></span>
                      </div>
                      <div className={`flex items-center gap-1 transition-colors ${fieldValidation.email ? 'text-green-600' : 'text-gray-400'}`}>
                        ...
                        <span><FormattedMessage id="registerClient.fields.email" /></span>
                      </div>
                      <div className={`flex items-center gap-1 transition-colors ${fieldValidation.password ? 'text-green-600' : 'text-gray-400'}`}>
                        ...
                        <span><FormattedMessage id="registerClient.fields.password" /></span>
                      </div>
                      <div className={`flex items-center gap-1 transition-colors ${fieldValidation.languagesSpoken ? 'text-green-600' : 'text-gray-400'}`}>
                        ...
                        <span><FormattedMessage id="registerClient.fields.languagesSpoken" /></span>
                      </div>
                      <div className={`flex items-center gap-1 col-span-2 transition-colors ${fieldValidation.terms ? 'text-green-600' : 'text-gray-400'}`}>
                        ...
                        <span><FormattedMessage id="registerClient.ui.termsLink" /></span>
                      </div>
                    </div>
                  </div>
                )}
